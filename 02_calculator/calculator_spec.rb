...
describe "#multiply" do
  ...
  it "multiplies from an empty array" do
	  expect(multiply([], 3)).to eq(0)
  end

  it "multiplies from 1 array" do
	  expect(multiply([2,3,4])).to eq(24)
  end

  it "multiplies multiple arrays" do 
	  expect(multiply([2,4],[10])).to eq(80)
  end

  it "multiplies nested arrays" do
